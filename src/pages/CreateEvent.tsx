      ...
      <div className="rounded-xl p-4 border space-y-3" style={{ backgroundColor: '#FFFFFF', borderColor: '#E4EBFA' }}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          <div>
            ...
            <textarea value={descText} onChange={(e) => setDescText(e.target.value.slice(0, 238))} rows={2} className="w-full px-3 py-1.5 rounded-lg text-xs light-form resize-none" />
          </div>
          <div>
