            ...
            <div className="flex items-start gap-2">
              ...
              <div className="flex-1">
                <textarea
                  ...
                  onChange={(e) => setDescriptionText(e.target.value.slice(0, 238))}
                  placeholder="Texto de descripción"
                  rows={2}
                  className="w-full px-3 py-1.5 rounded-lg text-xs light-form resize-none"
                />
                <p className="text-right text-[10px] mt-0.5" style={{ color: descriptionText.length >= 238 ? '#DC2626' : '#1D1D1F66' }}>
                  {descriptionText.length}/238
                </p>
              </div>
            </div>
          </div>
